...
vptree * vpt(double *Xarray, int n, int d, int *idxArray){
  ...
  //0. SETTING THE IDX OF THE TREE AS THE LAST POINT OF THE IDXARRAY OF THE TREE.
...
void innerAndOuterTree(double *euclideanDistances ,int numberOfSpots,int dimensions, vptree * tree,double * Xarr, int * idxArray ){
  ...
  //innerCount,outerCount are used for scaning given iputs and filling inner and outer trees
...
//////////////////////QUICKSELECT//////////////////////////////
/* ( source of the quickselect algorithm: https://www.geeksforgeeks.org/),
editted it for fitting the needs of  this program.)
*/
//Swap for using in the quickselect algorithm
void swap(double * xp, double * yp)
{
